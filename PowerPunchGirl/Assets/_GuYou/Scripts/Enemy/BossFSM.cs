...
public class BossFSM : MonoBehaviour
{
    ...
    enum EnemyState
    {
        Idle, Move, Attack, Return, Damaged, Die, SKILL1
    }
    ...
    public float sk1Cd = 20f;
    float skillTimer = 0f;

    public GameObject sk1Factory;

    public GameObject baseAtkPos;
    public GameObject bAtkFactory;
    ...
    void Skill1()
    {
        ...
        //스킬1 생성
        GameObject sk1Obj = Instantiate(sk1Factory);
        sk1Obj.transform.position = player.position;
    ...
    private void Move()
    {
        ...
        else//공격범위 안에 들어옴
        {
            ...
            //스킬1 생성
            GameObject sk2Obj = Instantiate(bAtkFactory);
            sk2Obj.transform.position = baseAtkPos.transform.position;
    ...
    private void Return()
    {
        ...
        //    state = EnemyState.Idle;
        //}
        //Debug.Log("개같은거 : "+Vector3.Distance(transform.position, startPoint));
